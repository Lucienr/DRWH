...
/* en tant que sys */
	...
	CREATE BIGFILE TABLESPACE TS_DWH_APP DATAFILE 
	  '/xxxx/xxxx/oradata/xxxxx/ts_dwh_app' SIZE 100M AUTOEXTEND ON NEXT 100M MAXSIZE 34359738344K
	LOGGING
	ONLINE
	...
	CREATE USER DWH_APP   IDENTIFIED BY XXXXX   DEFAULT TABLESPACE TS_DWH_APP   TEMPORARY TABLESPACE TEMP   PROFILE DEFAULT   ACCOUNT UNLOCK;
	-- 2 Roles for DWH_APP 
