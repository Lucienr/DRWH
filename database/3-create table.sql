...
create table DWH_ADMIN_ACTU
	(actu_num int, actu_text clob,actu_date date,published int,published_date date,alert int, primary key (actu_num)) 
TABLESPACE TS_DWH
LOGGING 
MONITORING;